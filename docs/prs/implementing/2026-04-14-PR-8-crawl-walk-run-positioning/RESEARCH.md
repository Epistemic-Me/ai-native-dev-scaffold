# RESEARCH: Reposition scaffold as Walk stage of Walk/Run/Sprint
...
The v2 deck reframes the maturity model as **Walk → Run → Sprint**, dimensioned across **People / Process / Tools**. This PR repositions the `ai-native-dev-scaffold-run` as the **Walk** stage so the example repo matches the deck's claims.
...
What's missing:
- `docs/.context/MCP_SERVERS.md` — the tool registry half of the Walk foundation
- Credential policy section in CLAUDE.md
- Any explicit "You Are Here" positioning on the Walk/Run/Sprint staircase
...
| No staircase positioning | Users don't understand this is one stage of three | Add "You Are Here" table to top of README and CLAUDE.md linking to Walk and Run scaffolds |
