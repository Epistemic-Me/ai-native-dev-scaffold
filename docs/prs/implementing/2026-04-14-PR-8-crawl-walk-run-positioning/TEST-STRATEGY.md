...
| T9 | README.md | Contains "You Are Here" table with links to sibling scaffolds | AC5 | `grep -q "ai-native-dev-scaffold-sprint"` |
...
- [ ] Sibling PR in `ai-native-dev-scaffold-sprint` tracked for consistency
