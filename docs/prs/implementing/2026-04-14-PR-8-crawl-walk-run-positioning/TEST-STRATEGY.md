...
| AC5 | `README.md` title includes "Walk Stage" and contains a "You Are Here" table linking to `ai-native-dev-scaffold-crawl` and `ai-native-dev-scaffold-compound` |
...
| T9 | README.md | Contains "You Are Here" table with links to sibling scaffolds | AC5 | `grep -q "ai-native-dev-scaffold-compound"` |
...
- [ ] Sibling PR in `ai-native-dev-scaffold-compound` tracked for consistency
